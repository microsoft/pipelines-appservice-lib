...
git add *
git commit -m "Copying built node_modules to webapps-deploy"
git push

Set-Location "C:\Users\sgollapudi\Documents\Work\LinuxGithubAction\pipelines-appservice-lib\packages\"
